      ...
      <div className="product-details-table">
        ...
        {order_products && order_products.length > 0 ? (
          <table>
            <thead>
              <tr>
                <th className='customer-order-heading'>Image</th>
                <th className='customer-order-heading'>Product Name</th>
                <th className='customer-order-heading'>Unit Price</th>
                <th className='customer-order-heading'>Discount</th>
                <th className='customer-order-heading'>Final Price</th>
                <th className='customer-order-heading'>Quantity</th>
                <th className='customer-order-heading'>Total Price</th>
              </tr>
            </thead>
            <tbody>
