            ...
            {orders.map((order, index) => (
                ...
                <div className="order-image">
                    ...
                    <div className="order-details">
                        ...
                        <div className="order-price-section order-discount-price"> ₹ {order.discount_price}.00</div>
                        <div className="order-price-section order-original-price"> ₹ {order.product_price}.00</div>
                        <div><strong>Quantity:</strong> {order.quantity}</div>
                        <div><strong>Total Price:</strong> ₹ {order.total_price}.00 </div>
                    </div>
                </div>
            ))}
