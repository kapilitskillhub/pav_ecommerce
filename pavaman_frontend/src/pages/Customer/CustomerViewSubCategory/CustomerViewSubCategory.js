    ...
    return (
        <div className="customer-dashboard container">
            ...
            {!loading && !error && (
                ...
                {/* <span className="breadcrumb-link" onClick={() => navigate("/view-categories")}>Categories</span> 
                <span className="breadcrumb-separator"> &gt; </span> */}
                {/* <span className="breadcrumb-link" onClick={() => navigate("/view-categories")}>{category_name}</span>
                */}
